...
const Navbar = () => {
  ...
  return (
    <nav aria-label="Main navigation" className="relative bg-sky-50 shadow-lg">
       <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between z-50 text-black">
      ...
      <div
        id="mobile-menu"
        className={`lg:hidden transition-max-height duration-500 overflow-hidden bg-sky-100 ${
